...
from app.schemas.task import TaskCreate, TaskRetrieve, TaskUpdate, ThinkTaskUpdate
...
async def update_task(task_id: str, task_update: TaskUpdate | ThinkTaskUpdate, db: AsyncSession = Depends(get_db)) \
        -> Task | None:
    ...
    if isinstance(task_update, ThinkTaskUpdate) and task_update.increment_retry_count:
