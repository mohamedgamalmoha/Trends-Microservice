...
class ThinkTask(Task):   
    ...
    def _get_request_headers(self, task_id: str) -> Dict[str, str]:
        """
    ...
    def on_retry(self, exc: Exception, task_id: str, args: tuple, kwargs: dict, einfo: billiard.einfo.ExceptionInfo) -> None:
        """
        Retry handler.
    ...
    def on_failure(self, exc: Exception, task_id: str, args: tuple, kwargs: dict, einfo: billiard.einfo.ExceptionInfo) -> None:
        """
        Error handler.
